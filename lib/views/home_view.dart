...
import 'information_view.dart'; // Pastikan file ini sudah dibuat
      ...
      body: SafeArea(
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              // HEADER YANG SUDAH DIUPDATE DENGAN TOMBOL INFO
              _buildTopHeader(),
    ...
    Widget navItem(int index, IconData icon, String label) {
      ...
      void onPressedAction() {
        if (isHome) {
          ...
          Navigator.push(
            context,
            MaterialPageRoute(builder: (c) => const NotifikasiView()),
          );
        } else if (index == 1) {
          Navigator.push(
            context,
            MaterialPageRoute(builder: (c) => const SavedClassesView()),
          );
        } else if (index == 3) {
          Navigator.push(
            context,
          ...
          Navigator.push(
            context,
            MaterialPageRoute(builder: (c) => const SettingsView()),
          );
        }
      }
  ...
  Widget _buildTopHeader() {
    ...
    return Row(
      ...
      children: [
        ...
        // Bagian Kanan: Tombol Informasi (Alur & Peta)
        Container(
          ...
          child: IconButton(
            ...
            tooltip: "Pusat Informasi & Peta",
            onPressed: () {
              // Navigasi ke halaman InformationView
              Navigator.push(
                context,
                MaterialPageRoute(
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'SKS yang diambil : ${_controller.totalSksTaken}',
              style: TextStyle(color: textGrey, fontSize: 12),
            ),
            const SizedBox(height: 16),
            Row(
